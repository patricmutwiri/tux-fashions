...
--
-- Table structure for table `oc2v_address`
--

DROP TABLE IF EXISTS `oc2v_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_address` (
...
--
-- Dumping data for table `oc2v_address`
--

LOCK TABLES `oc2v_address` WRITE;
/*!40000 ALTER TABLE `oc2v_address` DISABLE KEYS */;
INSERT INTO `oc2v_address` VALUES (1,1,'Patrick','Mutwiri','gbc','Ngong rd','','Nairobi','00100',110,1736,'');
/*!40000 ALTER TABLE `oc2v_address` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_affiliate`
--

DROP TABLE IF EXISTS `oc2v_affiliate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_affiliate` (
...
--
-- Dumping data for table `oc2v_affiliate`
--

LOCK TABLES `oc2v_affiliate` WRITE;
/*!40000 ALTER TABLE `oc2v_affiliate` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_affiliate` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_affiliate_activity`
--

DROP TABLE IF EXISTS `oc2v_affiliate_activity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_affiliate_activity` (
...
--
-- Dumping data for table `oc2v_affiliate_activity`
--

LOCK TABLES `oc2v_affiliate_activity` WRITE;
/*!40000 ALTER TABLE `oc2v_affiliate_activity` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_affiliate_activity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_affiliate_login`
--

DROP TABLE IF EXISTS `oc2v_affiliate_login`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_affiliate_login` (
...
--
-- Dumping data for table `oc2v_affiliate_login`
--

LOCK TABLES `oc2v_affiliate_login` WRITE;
/*!40000 ALTER TABLE `oc2v_affiliate_login` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_affiliate_login` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_affiliate_transaction`
--

DROP TABLE IF EXISTS `oc2v_affiliate_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_affiliate_transaction` (
...
--
-- Dumping data for table `oc2v_affiliate_transaction`
--

LOCK TABLES `oc2v_affiliate_transaction` WRITE;
/*!40000 ALTER TABLE `oc2v_affiliate_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_affiliate_transaction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_api`
--

DROP TABLE IF EXISTS `oc2v_api`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_api` (
...
--
-- Dumping data for table `oc2v_api`
--

LOCK TABLES `oc2v_api` WRITE;
/*!40000 ALTER TABLE `oc2v_api` DISABLE KEYS */;
INSERT INTO `oc2v_api` VALUES (1,'Default','',1,'2016-06-21 08:41:34','2016-06-21 08:41:34');
/*!40000 ALTER TABLE `oc2v_api` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_api_ip`
--

DROP TABLE IF EXISTS `oc2v_api_ip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_api_ip` (
...
--
-- Dumping data for table `oc2v_api_ip`
--

LOCK TABLES `oc2v_api_ip` WRITE;
/*!40000 ALTER TABLE `oc2v_api_ip` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_api_ip` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_api_session`
--

DROP TABLE IF EXISTS `oc2v_api_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_api_session` (
...
--
-- Dumping data for table `oc2v_api_session`
--

LOCK TABLES `oc2v_api_session` WRITE;
/*!40000 ALTER TABLE `oc2v_api_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_api_session` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_attribute`
--

DROP TABLE IF EXISTS `oc2v_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_attribute` (
...
--
-- Dumping data for table `oc2v_attribute`
--

LOCK TABLES `oc2v_attribute` WRITE;
/*!40000 ALTER TABLE `oc2v_attribute` DISABLE KEYS */;
INSERT INTO `oc2v_attribute` VALUES (1,6,1),(2,6,5),(3,6,3),(4,3,1),(5,3,2),(6,3,3),(7,3,4),(8,3,5),(9,3,6),(10,3,7),(11,3,8);
/*!40000 ALTER TABLE `oc2v_attribute` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_attribute_description`
--

DROP TABLE IF EXISTS `oc2v_attribute_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_attribute_description` (
...
--
-- Dumping data for table `oc2v_attribute_description`
--

LOCK TABLES `oc2v_attribute_description` WRITE;
/*!40000 ALTER TABLE `oc2v_attribute_description` DISABLE KEYS */;
INSERT INTO `oc2v_attribute_description` VALUES (1,1,'Description'),(2,1,'No. of Cores'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8'),(3,1,'Clockspeed');
/*!40000 ALTER TABLE `oc2v_attribute_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_attribute_group`
--

DROP TABLE IF EXISTS `oc2v_attribute_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_attribute_group` (
...
--
-- Dumping data for table `oc2v_attribute_group`
--

LOCK TABLES `oc2v_attribute_group` WRITE;
/*!40000 ALTER TABLE `oc2v_attribute_group` DISABLE KEYS */;
INSERT INTO `oc2v_attribute_group` VALUES (3,2),(4,1),(5,3),(6,4);
/*!40000 ALTER TABLE `oc2v_attribute_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_attribute_group_description`
--

DROP TABLE IF EXISTS `oc2v_attribute_group_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `oc2v_attribute_group_description`
--

LOCK TABLES `oc2v_attribute_group_description` WRITE;
/*!40000 ALTER TABLE `oc2v_attribute_group_description` DISABLE KEYS */;
INSERT INTO `oc2v_attribute_group_description` VALUES (3,1,'Memory'),(4,1,'Technical'),(5,1,'Motherboard'),(6,1,'Processor');
/*!40000 ALTER TABLE `oc2v_attribute_group_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_banner`
--

DROP TABLE IF EXISTS `oc2v_banner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_banner` (
...
--
-- Dumping data for table `oc2v_banner`
--

LOCK TABLES `oc2v_banner` WRITE;
/*!40000 ALTER TABLE `oc2v_banner` DISABLE KEYS */;
INSERT INTO `oc2v_banner` VALUES (6,'HP Products',1),(7,'Home Page Slideshow',1),(8,'Manufacturers',1);
/*!40000 ALTER TABLE `oc2v_banner` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_banner_image`
--

DROP TABLE IF EXISTS `oc2v_banner_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_banner_image` (
...
--
-- Dumping data for table `oc2v_banner_image`
--

LOCK TABLES `oc2v_banner_image` WRITE;
/*!40000 ALTER TABLE `oc2v_banner_image` DISABLE KEYS */;
INSERT INTO `oc2v_banner_image` VALUES (79,7,'index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),(87,6,'index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(94,8,'','catalog/demo/manufacturer/nfl.png',0),(95,8,'','catalog/demo/manufacturer/redbull.png',0),(96,8,'','catalog/demo/manufacturer/sony.png',0),(91,8,'','catalog/demo/manufacturer/cocacola.png',0),(92,8,'','catalog/demo/manufacturer/burgerking.png',0),(93,8,'','catalog/demo/manufacturer/canon.png',0),(88,8,'','catalog/demo/manufacturer/harley.png',0),(89,8,'','catalog/demo/manufacturer/dell.png',0),(90,8,'','catalog/demo/manufacturer/disney.png',0),(80,7,'','catalog/demo/banners/MacBookAir.jpg',0),(97,8,'','catalog/demo/manufacturer/starbucks.png',0),(98,8,'','catalog/demo/manufacturer/nintendo.png',0);
/*!40000 ALTER TABLE `oc2v_banner_image` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_banner_image_description`
--

DROP TABLE IF EXISTS `oc2v_banner_image_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_banner_image_description` (
...
--
-- Dumping data for table `oc2v_banner_image_description`
--

LOCK TABLES `oc2v_banner_image_description` WRITE;
/*!40000 ALTER TABLE `oc2v_banner_image_description` DISABLE KEYS */;
INSERT INTO `oc2v_banner_image_description` VALUES (79,1,7,'iPhone 6'),(87,1,6,'HP Banner'),(93,1,8,'Canon'),(92,1,8,'Burger King'),(91,1,8,'Coca Cola'),(90,1,8,'Disney'),(89,1,8,'Dell'),(80,1,7,'MacBookAir'),(88,1,8,'Harley Davidson'),(94,1,8,'NFL'),(95,1,8,'RedBull'),(96,1,8,'Sony'),(97,1,8,'Starbucks'),(98,1,8,'Nintendo');
/*!40000 ALTER TABLE `oc2v_banner_image_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_cart`
--

DROP TABLE IF EXISTS `oc2v_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_cart` (
...
--
-- Dumping data for table `oc2v_cart`
--

LOCK TABLES `oc2v_cart` WRITE;
/*!40000 ALTER TABLE `oc2v_cart` DISABLE KEYS */;
INSERT INTO `oc2v_cart` VALUES (2,1,'pafj5as5u8g19sq3ckv6mgrhb3',41,0,'[]',1,'2016-07-11 09:31:58');
/*!40000 ALTER TABLE `oc2v_cart` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_category`
--

DROP TABLE IF EXISTS `oc2v_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_category` (
...
--
-- Dumping data for table `oc2v_category_filter`
--

LOCK TABLES `oc2v_category_filter` WRITE;
/*!40000 ALTER TABLE `oc2v_category_filter` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_category_filter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_category_path`
--

DROP TABLE IF EXISTS `oc2v_category_path`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_category_to_layout`
--

LOCK TABLES `oc2v_category_to_layout` WRITE;
/*!40000 ALTER TABLE `oc2v_category_to_layout` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_category_to_layout` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_category_to_store`
--

DROP TABLE IF EXISTS `oc2v_category_to_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `oc2v_category_to_store`
--

LOCK TABLES `oc2v_category_to_store` WRITE;
/*!40000 ALTER TABLE `oc2v_category_to_store` DISABLE KEYS */;
INSERT INTO `oc2v_category_to_store` VALUES (17,0),(18,0),(20,0),(24,0),(25,0),(26,0),(27,0),(28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(37,0),(38,0),(39,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0),(50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0);
/*!40000 ALTER TABLE `oc2v_category_to_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_country`
--

DROP TABLE IF EXISTS `oc2v_country`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_country` (
...
--
-- Dumping data for table `oc2v_coupon`
--

LOCK TABLES `oc2v_coupon` WRITE;
/*!40000 ALTER TABLE `oc2v_coupon` DISABLE KEYS */;
INSERT INTO `oc2v_coupon` VALUES (4,'-10% Discount','2222','P',10.0000,0,0,0.0000,'2014-01-01','2020-01-01',10,'10',0,'2009-01-27 13:55:03'),(5,'Free Shipping','3333','P',0.0000,0,1,100.0000,'2014-01-01','2014-02-01',10,'10',0,'2009-03-14 21:13:53'),(6,'-10.00 Discount','1111','F',10.0000,0,0,10.0000,'2014-01-01','2020-01-01',100000,'10000',0,'2009-03-14 21:15:18');
/*!40000 ALTER TABLE `oc2v_coupon` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_coupon_category`
--

DROP TABLE IF EXISTS `oc2v_coupon_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_coupon_category` (
...
--
-- Dumping data for table `oc2v_coupon_category`
--

LOCK TABLES `oc2v_coupon_category` WRITE;
/*!40000 ALTER TABLE `oc2v_coupon_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_coupon_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_coupon_history`
--

DROP TABLE IF EXISTS `oc2v_coupon_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_coupon_history` (
...
--
-- Dumping data for table `oc2v_coupon_history`
--

LOCK TABLES `oc2v_coupon_history` WRITE;
/*!40000 ALTER TABLE `oc2v_coupon_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_coupon_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_coupon_product`
--

DROP TABLE IF EXISTS `oc2v_coupon_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_coupon_product` (
...
--
-- Dumping data for table `oc2v_coupon_product`
--

LOCK TABLES `oc2v_coupon_product` WRITE;
/*!40000 ALTER TABLE `oc2v_coupon_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_coupon_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_currency`
--

DROP TABLE IF EXISTS `oc2v_currency`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_currency` (
...
--
-- Dumping data for table `oc2v_currency`
--

LOCK TABLES `oc2v_currency` WRITE;
/*!40000 ALTER TABLE `oc2v_currency` DISABLE KEYS */;
INSERT INTO `oc2v_currency` VALUES (1,'Pound Sterling','GBP','£','','2',0.75790000,1,'2016-07-28 07:01:33'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2016-07-28 07:09:13'),(3,'Euro','EUR','','€','2',0.90140003,1,'2016-07-28 07:01:33');
/*!40000 ALTER TABLE `oc2v_currency` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_custom_field`
--

DROP TABLE IF EXISTS `oc2v_custom_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_custom_field` (
...
--
-- Dumping data for table `oc2v_custom_field`
--

LOCK TABLES `oc2v_custom_field` WRITE;
/*!40000 ALTER TABLE `oc2v_custom_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_custom_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_custom_field_customer_group`
--

DROP TABLE IF EXISTS `oc2v_custom_field_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_custom_field_customer_group` (
...
--
-- Dumping data for table `oc2v_custom_field_customer_group`
--

LOCK TABLES `oc2v_custom_field_customer_group` WRITE;
/*!40000 ALTER TABLE `oc2v_custom_field_customer_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_custom_field_customer_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_custom_field_description`
--

DROP TABLE IF EXISTS `oc2v_custom_field_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
--
-- Dumping data for table `oc2v_custom_field_description`
--

LOCK TABLES `oc2v_custom_field_description` WRITE;
/*!40000 ALTER TABLE `oc2v_custom_field_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_custom_field_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_custom_field_value`
--

DROP TABLE IF EXISTS `oc2v_custom_field_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_custom_field_value` (
...
--
-- Dumping data for table `oc2v_custom_field_value`
--

LOCK TABLES `oc2v_custom_field_value` WRITE;
/*!40000 ALTER TABLE `oc2v_custom_field_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_custom_field_value` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_custom_field_value_description`
--

DROP TABLE IF EXISTS `oc2v_custom_field_value_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_custom_field_value_description` (
...
--
-- Dumping data for table `oc2v_custom_field_value_description`
--

LOCK TABLES `oc2v_custom_field_value_description` WRITE;
/*!40000 ALTER TABLE `oc2v_custom_field_value_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_custom_field_value_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer`
--

DROP TABLE IF EXISTS `oc2v_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer` (
...
--
-- Dumping data for table `oc2v_customer`
--

LOCK TABLES `oc2v_customer` WRITE;
/*!40000 ALTER TABLE `oc2v_customer` DISABLE KEYS */;
INSERT INTO `oc2v_customer` VALUES (1,1,0,'Patrick','Mutwiri','patwiri@gmail.com','0727542899','','9686421d2378568e0b90ab30055bbce03496a281','Nm9jzG2BG',NULL,NULL,1,1,'','127.0.0.1',1,1,0,'','','2016-07-11 09:30:57');
/*!40000 ALTER TABLE `oc2v_customer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_activity`
--

DROP TABLE IF EXISTS `oc2v_customer_activity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_activity` (
...
--
-- Dumping data for table `oc2v_customer_activity`
--

LOCK TABLES `oc2v_customer_activity` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_activity` DISABLE KEYS */;
INSERT INTO `oc2v_customer_activity` VALUES (1,1,'register','{\"customer_id\":1,\"name\":\"Patrick Mutwiri\"}','127.0.0.1','2016-07-11 09:31:58');
/*!40000 ALTER TABLE `oc2v_customer_activity` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_group`
--

DROP TABLE IF EXISTS `oc2v_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_group` (
...
--
-- Dumping data for table `oc2v_customer_group`
--

LOCK TABLES `oc2v_customer_group` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_group` DISABLE KEYS */;
INSERT INTO `oc2v_customer_group` VALUES (1,0,1);
/*!40000 ALTER TABLE `oc2v_customer_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_group_description`
--

DROP TABLE IF EXISTS `oc2v_customer_group_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_customer_group_description`
--

LOCK TABLES `oc2v_customer_group_description` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_group_description` DISABLE KEYS */;
INSERT INTO `oc2v_customer_group_description` VALUES (1,1,'Default','test');
/*!40000 ALTER TABLE `oc2v_customer_group_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_history`
--

DROP TABLE IF EXISTS `oc2v_customer_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_history` (
...
--
-- Dumping data for table `oc2v_customer_history`
--

LOCK TABLES `oc2v_customer_history` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_customer_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_ip`
--

DROP TABLE IF EXISTS `oc2v_customer_ip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_ip` (
...
--
-- Dumping data for table `oc2v_customer_ip`
--

LOCK TABLES `oc2v_customer_ip` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_ip` DISABLE KEYS */;
INSERT INTO `oc2v_customer_ip` VALUES (1,1,'127.0.0.1','2016-07-11 09:31:58');
/*!40000 ALTER TABLE `oc2v_customer_ip` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_login`
--

DROP TABLE IF EXISTS `oc2v_customer_login`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_login` (
...
--
-- Dumping data for table `oc2v_customer_login`
--

LOCK TABLES `oc2v_customer_login` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_login` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_customer_login` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_online`
--

DROP TABLE IF EXISTS `oc2v_customer_online`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Dumping data for table `oc2v_customer_online`
--

LOCK TABLES `oc2v_customer_online` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_online` DISABLE KEYS */;
INSERT INTO `oc2v_customer_online` VALUES ('127.0.0.1',0,'http://localhost/opencart/index.php?route=product/product&amp;product_id=43','http://localhost/opencart/','2016-07-28 07:26:46');
/*!40000 ALTER TABLE `oc2v_customer_online` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_reward`
--

DROP TABLE IF EXISTS `oc2v_customer_reward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_reward` (
...
--
-- Dumping data for table `oc2v_customer_reward`
--

LOCK TABLES `oc2v_customer_reward` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_reward` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_customer_reward` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_transaction`
--

DROP TABLE IF EXISTS `oc2v_customer_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_transaction` (
...
--
-- Dumping data for table `oc2v_customer_transaction`
--

LOCK TABLES `oc2v_customer_transaction` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_customer_transaction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_customer_wishlist`
--

DROP TABLE IF EXISTS `oc2v_customer_wishlist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Dumping data for table `oc2v_customer_wishlist`
--

LOCK TABLES `oc2v_customer_wishlist` WRITE;
/*!40000 ALTER TABLE `oc2v_customer_wishlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_customer_wishlist` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_download`
--

DROP TABLE IF EXISTS `oc2v_download`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_download` (
...
--
-- Dumping data for table `oc2v_download`
--

LOCK TABLES `oc2v_download` WRITE;
/*!40000 ALTER TABLE `oc2v_download` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_download` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_download_description`
--

DROP TABLE IF EXISTS `oc2v_download_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_download_description` (
...
--
-- Dumping data for table `oc2v_download_description`
--

LOCK TABLES `oc2v_download_description` WRITE;
/*!40000 ALTER TABLE `oc2v_download_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_download_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_event`
--

DROP TABLE IF EXISTS `oc2v_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_event` (
...
--
-- Dumping data for table `oc2v_event`
--

LOCK TABLES `oc2v_event` WRITE;
/*!40000 ALTER TABLE `oc2v_event` DISABLE KEYS */;
INSERT INTO `oc2v_event` VALUES (1,'voucher','catalog/model/checkout/order/addHistory/after','total/voucher/send');
/*!40000 ALTER TABLE `oc2v_event` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_extension`
--

DROP TABLE IF EXISTS `oc2v_extension`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_extension` (
...
--
-- Dumping data for table `oc2v_extension`
--

LOCK TABLES `oc2v_extension` WRITE;
/*!40000 ALTER TABLE `oc2v_extension` DISABLE KEYS */;
INSERT INTO `oc2v_extension` VALUES (1,'payment','cod'),(2,'total','shipping'),(3,'total','sub_total'),(4,'total','tax'),(5,'total','total'),(6,'module','banner'),(7,'module','carousel'),(8,'total','credit'),(9,'shipping','flat'),(10,'total','handling'),(11,'total','low_order_fee'),(12,'total','coupon'),(13,'module','category'),(14,'module','account'),(15,'total','reward'),(16,'total','voucher'),(17,'payment','free_checkout'),(18,'module','featured'),(19,'module','slideshow'),(20,'theme','theme_default');
/*!40000 ALTER TABLE `oc2v_extension` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_filter`
--

DROP TABLE IF EXISTS `oc2v_filter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_filter` (
...
--
-- Dumping data for table `oc2v_filter`
--

LOCK TABLES `oc2v_filter` WRITE;
/*!40000 ALTER TABLE `oc2v_filter` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_filter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_filter_description`
--

DROP TABLE IF EXISTS `oc2v_filter_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `oc2v_filter_description`
--

LOCK TABLES `oc2v_filter_description` WRITE;
/*!40000 ALTER TABLE `oc2v_filter_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_filter_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_filter_group`
--

DROP TABLE IF EXISTS `oc2v_filter_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_filter_group` (
...
--
-- Dumping data for table `oc2v_filter_group`
--

LOCK TABLES `oc2v_filter_group` WRITE;
/*!40000 ALTER TABLE `oc2v_filter_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_filter_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_filter_group_description`
--

DROP TABLE IF EXISTS `oc2v_filter_group_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `oc2v_filter_group_description`
--

LOCK TABLES `oc2v_filter_group_description` WRITE;
/*!40000 ALTER TABLE `oc2v_filter_group_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_filter_group_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_geo_zone`
--

DROP TABLE IF EXISTS `oc2v_geo_zone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_geo_zone` (
...
--
-- Dumping data for table `oc2v_geo_zone`
--

LOCK TABLES `oc2v_geo_zone` WRITE;
/*!40000 ALTER TABLE `oc2v_geo_zone` DISABLE KEYS */;
INSERT INTO `oc2v_geo_zone` VALUES (3,'UK VAT Zone','UK VAT','2010-02-26 22:33:24','2009-01-06 23:26:25'),(4,'UK Shipping','UK Shipping Zones','2010-12-15 15:18:13','2009-06-23 01:14:53');
/*!40000 ALTER TABLE `oc2v_geo_zone` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_information`
--

DROP TABLE IF EXISTS `oc2v_information`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_information` (
...
--
-- Dumping data for table `oc2v_information`
--

LOCK TABLES `oc2v_information` WRITE;
/*!40000 ALTER TABLE `oc2v_information` DISABLE KEYS */;
INSERT INTO `oc2v_information` VALUES (3,1,3,1),(4,1,1,1),(5,1,4,1),(6,1,2,1);
/*!40000 ALTER TABLE `oc2v_information` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_information_description`
--

DROP TABLE IF EXISTS `oc2v_information_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_information_description` (
...
--
-- Dumping data for table `oc2v_information_description`
--

LOCK TABLES `oc2v_information_description` WRITE;
/*!40000 ALTER TABLE `oc2v_information_description` DISABLE KEYS */;
INSERT INTO `oc2v_information_description` VALUES (4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),(5,1,'Terms &amp; Conditions','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Terms &amp; Conditions','',''),(3,1,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','',''),(6,1,'Delivery Information','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','Delivery Information','','');
/*!40000 ALTER TABLE `oc2v_information_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_information_to_layout`
--

DROP TABLE IF EXISTS `oc2v_information_to_layout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_information_to_layout`
--

LOCK TABLES `oc2v_information_to_layout` WRITE;
/*!40000 ALTER TABLE `oc2v_information_to_layout` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_information_to_layout` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_information_to_store`
--

DROP TABLE IF EXISTS `oc2v_information_to_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `oc2v_information_to_store`
--

LOCK TABLES `oc2v_information_to_store` WRITE;
/*!40000 ALTER TABLE `oc2v_information_to_store` DISABLE KEYS */;
INSERT INTO `oc2v_information_to_store` VALUES (3,0),(4,0),(5,0),(6,0);
/*!40000 ALTER TABLE `oc2v_information_to_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_language`
--

DROP TABLE IF EXISTS `oc2v_language`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_language` (
...
--
-- Dumping data for table `oc2v_language`
--

LOCK TABLES `oc2v_language` WRITE;
/*!40000 ALTER TABLE `oc2v_language` DISABLE KEYS */;
INSERT INTO `oc2v_language` VALUES (1,'English','en-gb','en_US.UTF-8,en_US,en-gb,english','gb.png','english',1,1);
/*!40000 ALTER TABLE `oc2v_language` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_layout`
--

DROP TABLE IF EXISTS `oc2v_layout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_layout` (
...
--
-- Dumping data for table `oc2v_layout`
--

LOCK TABLES `oc2v_layout` WRITE;
/*!40000 ALTER TABLE `oc2v_layout` DISABLE KEYS */;
INSERT INTO `oc2v_layout` VALUES (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search');
/*!40000 ALTER TABLE `oc2v_layout` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_layout_module`
--

DROP TABLE IF EXISTS `oc2v_layout_module`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_layout_module` (
...
--
-- Dumping data for table `oc2v_layout_module`
--

LOCK TABLES `oc2v_layout_module` WRITE;
/*!40000 ALTER TABLE `oc2v_layout_module` DISABLE KEYS */;
INSERT INTO `oc2v_layout_module` VALUES (2,4,'0','content_top',0),(3,4,'0','content_top',1),(20,5,'0','column_left',2),(69,10,'affiliate','column_right',1),(68,6,'account','column_right',1),(67,1,'carousel.29','content_top',3),(66,1,'slideshow.27','content_top',1),(65,1,'featured.28','content_top',2),(72,3,'category','column_left',1),(73,3,'banner.30','column_left',2);
/*!40000 ALTER TABLE `oc2v_layout_module` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_layout_route`
--

DROP TABLE IF EXISTS `oc2v_layout_route`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_layout_route` (
...
--
-- Dumping data for table `oc2v_layout_route`
--

LOCK TABLES `oc2v_layout_route` WRITE;
/*!40000 ALTER TABLE `oc2v_layout_route` DISABLE KEYS */;
INSERT INTO `oc2v_layout_route` VALUES (38,6,0,'account/%'),(17,10,0,'affiliate/%'),(44,3,0,'product/category'),(42,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(23,7,0,'checkout/%'),(31,8,0,'information/contact'),(32,9,0,'information/sitemap'),(34,4,0,''),(45,5,0,'product/manufacturer'),(52,12,0,'product/compare'),(53,13,0,'product/search');
/*!40000 ALTER TABLE `oc2v_layout_route` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_length_class`
--

DROP TABLE IF EXISTS `oc2v_length_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_length_class` (
...
--
-- Dumping data for table `oc2v_length_class`
--

LOCK TABLES `oc2v_length_class` WRITE;
/*!40000 ALTER TABLE `oc2v_length_class` DISABLE KEYS */;
INSERT INTO `oc2v_length_class` VALUES (1,1.00000000),(2,10.00000000),(3,0.39370000);
/*!40000 ALTER TABLE `oc2v_length_class` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_length_class_description`
--

DROP TABLE IF EXISTS `oc2v_length_class_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_length_class_description` (
...
--
-- Dumping data for table `oc2v_length_class_description`
--

LOCK TABLES `oc2v_length_class_description` WRITE;
/*!40000 ALTER TABLE `oc2v_length_class_description` DISABLE KEYS */;
INSERT INTO `oc2v_length_class_description` VALUES (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in');
/*!40000 ALTER TABLE `oc2v_length_class_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_location`
--

DROP TABLE IF EXISTS `oc2v_location`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_location` (
...
--
-- Dumping data for table `oc2v_location`
--

LOCK TABLES `oc2v_location` WRITE;
/*!40000 ALTER TABLE `oc2v_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_location` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_manufacturer`
--

DROP TABLE IF EXISTS `oc2v_manufacturer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_manufacturer` (
...
--
-- Dumping data for table `oc2v_manufacturer`
--

LOCK TABLES `oc2v_manufacturer` WRITE;
/*!40000 ALTER TABLE `oc2v_manufacturer` DISABLE KEYS */;
INSERT INTO `oc2v_manufacturer` VALUES (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'Hewlett-Packard','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);
/*!40000 ALTER TABLE `oc2v_manufacturer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_manufacturer_to_store`
--

DROP TABLE IF EXISTS `oc2v_manufacturer_to_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_manufacturer_to_store` (
...
--
-- Dumping data for table `oc2v_manufacturer_to_store`
--

LOCK TABLES `oc2v_manufacturer_to_store` WRITE;
/*!40000 ALTER TABLE `oc2v_manufacturer_to_store` DISABLE KEYS */;
INSERT INTO `oc2v_manufacturer_to_store` VALUES (5,0),(6,0),(7,0),(8,0),(9,0),(10,0);
/*!40000 ALTER TABLE `oc2v_manufacturer_to_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_marketing`
--

DROP TABLE IF EXISTS `oc2v_marketing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_marketing` (
...
--
-- Dumping data for table `oc2v_marketing`
--

LOCK TABLES `oc2v_marketing` WRITE;
/*!40000 ALTER TABLE `oc2v_marketing` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_marketing` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_modification`
--

DROP TABLE IF EXISTS `oc2v_modification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_modification` (
...
--
-- Dumping data for table `oc2v_modification`
--

LOCK TABLES `oc2v_modification` WRITE;
/*!40000 ALTER TABLE `oc2v_modification` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_modification` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_module`
--

DROP TABLE IF EXISTS `oc2v_module`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_module` (
...
--
-- Dumping data for table `oc2v_option`
--

LOCK TABLES `oc2v_option` WRITE;
/*!40000 ALTER TABLE `oc2v_option` DISABLE KEYS */;
INSERT INTO `oc2v_option` VALUES (1,'radio',1),(2,'checkbox',2),(4,'text',3),(5,'select',4),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',10),(12,'date',11);
/*!40000 ALTER TABLE `oc2v_option` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_option_description`
--

DROP TABLE IF EXISTS `oc2v_option_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_option_description` (
...
--
-- Dumping data for table `oc2v_option_description`
--

LOCK TABLES `oc2v_option_description` WRITE;
/*!40000 ALTER TABLE `oc2v_option_description` DISABLE KEYS */;
INSERT INTO `oc2v_option_description` VALUES (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size');
/*!40000 ALTER TABLE `oc2v_option_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_option_value`
--

DROP TABLE IF EXISTS `oc2v_option_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_option_value` (
...
--
-- Dumping data for table `oc2v_option_value`
--

LOCK TABLES `oc2v_option_value` WRITE;
/*!40000 ALTER TABLE `oc2v_option_value` DISABLE KEYS */;
INSERT INTO `oc2v_option_value` VALUES (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3);
/*!40000 ALTER TABLE `oc2v_option_value` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_option_value_description`
--

DROP TABLE IF EXISTS `oc2v_option_value_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_option_value_description` (
...
--
-- Dumping data for table `oc2v_option_value_description`
--

LOCK TABLES `oc2v_option_value_description` WRITE;
/*!40000 ALTER TABLE `oc2v_option_value_description` DISABLE KEYS */;
INSERT INTO `oc2v_option_value_description` VALUES (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small');
/*!40000 ALTER TABLE `oc2v_option_value_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order`
--

DROP TABLE IF EXISTS `oc2v_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order` (
...
--
-- Dumping data for table `oc2v_order`
--

LOCK TABLES `oc2v_order` WRITE;
/*!40000 ALTER TABLE `oc2v_order` DISABLE KEYS */;
INSERT INTO `oc2v_order` VALUES (1,0,'INV-2013-00',0,'Your Store','http://localhost/opencart/',1,1,'Patrick','Mutwiri','patwiri@gmail.com','0727542899','','','Patrick','Mutwiri','gbc','Ngong rd','','Nairobi','00100','Kenya',110,'Nairobi Area',1736,'','[]','Cash On Delivery','cod','Patrick','Mutwiri','gbc','Ngong rd','','Nairobi','00100','Kenya',110,'Nairobi Area',1736,'','[]','Flat Shipping Rate','flat.flat','test',105.0000,0,0,0.0000,0,'',1,2,'USD',1.00000000,'127.0.0.1','','Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:47.0) Gecko/20100101 Firefox/47.0','en-US,en;q=0.5','2016-07-11 09:46:01','2016-07-11 09:46:01');
/*!40000 ALTER TABLE `oc2v_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_custom_field`
--

DROP TABLE IF EXISTS `oc2v_order_custom_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_custom_field` (
...
--
-- Dumping data for table `oc2v_order_custom_field`
--

LOCK TABLES `oc2v_order_custom_field` WRITE;
/*!40000 ALTER TABLE `oc2v_order_custom_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_order_custom_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_history`
--

DROP TABLE IF EXISTS `oc2v_order_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_history` (
...
--
-- Dumping data for table `oc2v_order_history`
--

LOCK TABLES `oc2v_order_history` WRITE;
/*!40000 ALTER TABLE `oc2v_order_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_order_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_option`
--

DROP TABLE IF EXISTS `oc2v_order_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_option` (
...
--
-- Dumping data for table `oc2v_order_option`
--

LOCK TABLES `oc2v_order_option` WRITE;
/*!40000 ALTER TABLE `oc2v_order_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_order_option` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_product`
--

DROP TABLE IF EXISTS `oc2v_order_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_product` (
...
--
-- Dumping data for table `oc2v_order_product`
--

LOCK TABLES `oc2v_order_product` WRITE;
/*!40000 ALTER TABLE `oc2v_order_product` DISABLE KEYS */;
INSERT INTO `oc2v_order_product` VALUES (1,1,41,'iMac','Product 14',1,100.0000,100.0000,0.0000,0);
/*!40000 ALTER TABLE `oc2v_order_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_recurring`
--

DROP TABLE IF EXISTS `oc2v_order_recurring`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_recurring` (
...
--
-- Dumping data for table `oc2v_order_recurring`
--

LOCK TABLES `oc2v_order_recurring` WRITE;
/*!40000 ALTER TABLE `oc2v_order_recurring` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_order_recurring` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_recurring_transaction`
--

DROP TABLE IF EXISTS `oc2v_order_recurring_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_recurring_transaction` (
...
--
-- Dumping data for table `oc2v_order_recurring_transaction`
--

LOCK TABLES `oc2v_order_recurring_transaction` WRITE;
/*!40000 ALTER TABLE `oc2v_order_recurring_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_order_recurring_transaction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_status`
--

DROP TABLE IF EXISTS `oc2v_order_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_status` (
...
--
-- Dumping data for table `oc2v_order_status`
--

LOCK TABLES `oc2v_order_status` WRITE;
/*!40000 ALTER TABLE `oc2v_order_status` DISABLE KEYS */;
INSERT INTO `oc2v_order_status` VALUES (2,1,'Processing'),(3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(11,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(1,1,'Pending'),(16,1,'Voided'),(15,1,'Processed'),(14,1,'Expired');
/*!40000 ALTER TABLE `oc2v_order_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_total`
--

DROP TABLE IF EXISTS `oc2v_order_total`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_total` (
...
--
-- Dumping data for table `oc2v_order_total`
--

LOCK TABLES `oc2v_order_total` WRITE;
/*!40000 ALTER TABLE `oc2v_order_total` DISABLE KEYS */;
INSERT INTO `oc2v_order_total` VALUES (1,1,'sub_total','Sub-Total',100.0000,1),(2,1,'shipping','Flat Shipping Rate',5.0000,3),(3,1,'total','Total',105.0000,9);
/*!40000 ALTER TABLE `oc2v_order_total` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_order_voucher`
--

DROP TABLE IF EXISTS `oc2v_order_voucher`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_order_voucher` (
...
--
-- Dumping data for table `oc2v_order_voucher`
--

LOCK TABLES `oc2v_order_voucher` WRITE;
/*!40000 ALTER TABLE `oc2v_order_voucher` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_order_voucher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product`
--

DROP TABLE IF EXISTS `oc2v_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product` (
...
--
-- Dumping data for table `oc2v_product_attribute`
--

LOCK TABLES `oc2v_product_attribute` WRITE;
/*!40000 ALTER TABLE `oc2v_product_attribute` DISABLE KEYS */;
INSERT INTO `oc2v_product_attribute` VALUES (43,2,1,'1'),(47,4,1,'16GB'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,2,1,'4');
/*!40000 ALTER TABLE `oc2v_product_attribute` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_description`
--

DROP TABLE IF EXISTS `oc2v_product_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `oc2v_product_discount`
--

LOCK TABLES `oc2v_product_discount` WRITE;
/*!40000 ALTER TABLE `oc2v_product_discount` DISABLE KEYS */;
INSERT INTO `oc2v_product_discount` VALUES (440,42,1,30,1,66.0000,'0000-00-00','0000-00-00'),(439,42,1,20,1,77.0000,'0000-00-00','0000-00-00'),(438,42,1,10,1,88.0000,'0000-00-00','0000-00-00');
/*!40000 ALTER TABLE `oc2v_product_discount` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_filter`
--

DROP TABLE IF EXISTS `oc2v_product_filter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_product_filter`
--

LOCK TABLES `oc2v_product_filter` WRITE;
/*!40000 ALTER TABLE `oc2v_product_filter` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_product_filter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_image`
--

DROP TABLE IF EXISTS `oc2v_product_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_image` (
...
--
-- Dumping data for table `oc2v_product_option`
--

LOCK TABLES `oc2v_product_option` WRITE;
/*!40000 ALTER TABLE `oc2v_product_option` DISABLE KEYS */;
INSERT INTO `oc2v_product_option` VALUES (224,35,11,'',1),(225,47,12,'2011-04-22',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'test',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(221,42,9,'22:25',1),(220,42,10,'2011-02-20 22:25',1),(226,30,5,'',1);
/*!40000 ALTER TABLE `oc2v_product_option` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_option_value`
--

DROP TABLE IF EXISTS `oc2v_product_option_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_option_value` (
...
--
-- Dumping data for table `oc2v_product_recurring`
--

LOCK TABLES `oc2v_product_recurring` WRITE;
/*!40000 ALTER TABLE `oc2v_product_recurring` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_product_recurring` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_related`
--

DROP TABLE IF EXISTS `oc2v_product_related`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_product_related`
--

LOCK TABLES `oc2v_product_related` WRITE;
/*!40000 ALTER TABLE `oc2v_product_related` DISABLE KEYS */;
INSERT INTO `oc2v_product_related` VALUES (40,42),(41,42),(42,40),(42,41);
/*!40000 ALTER TABLE `oc2v_product_related` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_reward`
--

DROP TABLE IF EXISTS `oc2v_product_reward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_reward` (
...
--
-- Dumping data for table `oc2v_product_reward`
--

LOCK TABLES `oc2v_product_reward` WRITE;
/*!40000 ALTER TABLE `oc2v_product_reward` DISABLE KEYS */;
INSERT INTO `oc2v_product_reward` VALUES (515,42,1,100),(519,47,1,300),(379,28,1,400),(329,43,1,600),(339,29,1,0),(343,48,1,0),(335,40,1,0),(539,30,1,200),(331,44,1,700),(333,45,1,800),(337,31,1,0),(425,35,1,0),(345,33,1,0),(347,46,1,0),(545,41,1,0),(351,36,1,0),(353,34,1,0),(355,32,1,0),(521,49,1,1000);
/*!40000 ALTER TABLE `oc2v_product_reward` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_special`
--

DROP TABLE IF EXISTS `oc2v_product_special`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_special` (
...
--
-- Dumping data for table `oc2v_product_special`
--

LOCK TABLES `oc2v_product_special` WRITE;
/*!40000 ALTER TABLE `oc2v_product_special` DISABLE KEYS */;
INSERT INTO `oc2v_product_special` VALUES (419,42,1,1,90.0000,'0000-00-00','0000-00-00'),(439,30,1,2,90.0000,'0000-00-00','0000-00-00'),(438,30,1,1,80.0000,'0000-00-00','0000-00-00');
/*!40000 ALTER TABLE `oc2v_product_special` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_to_category`
--

DROP TABLE IF EXISTS `oc2v_product_to_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_product_to_category`
--

LOCK TABLES `oc2v_product_to_category` WRITE;
/*!40000 ALTER TABLE `oc2v_product_to_category` DISABLE KEYS */;
INSERT INTO `oc2v_product_to_category` VALUES (28,20),(28,24),(29,20),(29,24),(30,20),(30,33),(31,33),(32,34),(33,20),(33,28),(34,34),(35,20),(36,34),(40,20),(40,24),(41,27),(42,20),(42,28),(43,18),(43,20),(44,18),(44,20),(45,18),(46,18),(46,20),(47,18),(47,20),(48,20),(48,34),(49,57);
/*!40000 ALTER TABLE `oc2v_product_to_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_to_download`
--

DROP TABLE IF EXISTS `oc2v_product_to_download`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_product_to_download`
--

LOCK TABLES `oc2v_product_to_download` WRITE;
/*!40000 ALTER TABLE `oc2v_product_to_download` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_product_to_download` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_to_layout`
--

DROP TABLE IF EXISTS `oc2v_product_to_layout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc2v_product_to_layout`
--

LOCK TABLES `oc2v_product_to_layout` WRITE;
/*!40000 ALTER TABLE `oc2v_product_to_layout` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_product_to_layout` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_product_to_store`
--

DROP TABLE IF EXISTS `oc2v_product_to_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `oc2v_product_to_store`
--

LOCK TABLES `oc2v_product_to_store` WRITE;
/*!40000 ALTER TABLE `oc2v_product_to_store` DISABLE KEYS */;
INSERT INTO `oc2v_product_to_store` VALUES (28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0);
/*!40000 ALTER TABLE `oc2v_product_to_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_recurring`
--

DROP TABLE IF EXISTS `oc2v_recurring`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_recurring` (
...
--
-- Dumping data for table `oc2v_recurring`
--

LOCK TABLES `oc2v_recurring` WRITE;
/*!40000 ALTER TABLE `oc2v_recurring` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_recurring` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_recurring_description`
--

DROP TABLE IF EXISTS `oc2v_recurring_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `oc2v_recurring_description`
--

LOCK TABLES `oc2v_recurring_description` WRITE;
/*!40000 ALTER TABLE `oc2v_recurring_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_recurring_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_return`
--

DROP TABLE IF EXISTS `oc2v_return`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_return` (
...
--
-- Dumping data for table `oc2v_return`
--

LOCK TABLES `oc2v_return` WRITE;
/*!40000 ALTER TABLE `oc2v_return` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_return` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_return_action`
--

DROP TABLE IF EXISTS `oc2v_return_action`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_return_action` (
...
--
-- Dumping data for table `oc2v_return_action`
--

LOCK TABLES `oc2v_return_action` WRITE;
/*!40000 ALTER TABLE `oc2v_return_action` DISABLE KEYS */;
INSERT INTO `oc2v_return_action` VALUES (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent');
/*!40000 ALTER TABLE `oc2v_return_action` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_return_history`
--

DROP TABLE IF EXISTS `oc2v_return_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_return_history` (
...
--
-- Dumping data for table `oc2v_return_history`
--

LOCK TABLES `oc2v_return_history` WRITE;
/*!40000 ALTER TABLE `oc2v_return_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_return_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_return_reason`
--

DROP TABLE IF EXISTS `oc2v_return_reason`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_return_reason` (
...
--
-- Dumping data for table `oc2v_return_reason`
--

LOCK TABLES `oc2v_return_reason` WRITE;
/*!40000 ALTER TABLE `oc2v_return_reason` DISABLE KEYS */;
INSERT INTO `oc2v_return_reason` VALUES (1,1,'Dead On Arrival'),(2,1,'Received Wrong Item'),(3,1,'Order Error'),(4,1,'Faulty, please supply details'),(5,1,'Other, please supply details');
/*!40000 ALTER TABLE `oc2v_return_reason` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_return_status`
--

DROP TABLE IF EXISTS `oc2v_return_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_return_status` (
...
--
-- Dumping data for table `oc2v_return_status`
--

LOCK TABLES `oc2v_return_status` WRITE;
/*!40000 ALTER TABLE `oc2v_return_status` DISABLE KEYS */;
INSERT INTO `oc2v_return_status` VALUES (1,1,'Pending'),(3,1,'Complete'),(2,1,'Awaiting Products');
/*!40000 ALTER TABLE `oc2v_return_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_review`
--

DROP TABLE IF EXISTS `oc2v_review`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_review` (
...
--
-- Dumping data for table `oc2v_review`
--

LOCK TABLES `oc2v_review` WRITE;
/*!40000 ALTER TABLE `oc2v_review` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_review` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_setting`
--

DROP TABLE IF EXISTS `oc2v_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_setting` (
...
--
-- Dumping data for table `oc2v_stock_status`
--

LOCK TABLES `oc2v_stock_status` WRITE;
/*!40000 ALTER TABLE `oc2v_stock_status` DISABLE KEYS */;
INSERT INTO `oc2v_stock_status` VALUES (7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock'),(6,1,'2-3 Days');
/*!40000 ALTER TABLE `oc2v_stock_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_store`
--

DROP TABLE IF EXISTS `oc2v_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_store` (
...
--
-- Dumping data for table `oc2v_store`
--

LOCK TABLES `oc2v_store` WRITE;
/*!40000 ALTER TABLE `oc2v_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_tax_class`
--

DROP TABLE IF EXISTS `oc2v_tax_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_tax_class` (
...
--
-- Dumping data for table `oc2v_tax_class`
--

LOCK TABLES `oc2v_tax_class` WRITE;
/*!40000 ALTER TABLE `oc2v_tax_class` DISABLE KEYS */;
INSERT INTO `oc2v_tax_class` VALUES (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');
/*!40000 ALTER TABLE `oc2v_tax_class` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_tax_rate`
--

DROP TABLE IF EXISTS `oc2v_tax_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_tax_rate` (
...
--
-- Dumping data for table `oc2v_tax_rate`
--

LOCK TABLES `oc2v_tax_rate` WRITE;
/*!40000 ALTER TABLE `oc2v_tax_rate` DISABLE KEYS */;
INSERT INTO `oc2v_tax_rate` VALUES (86,3,'VAT (20%)',20.0000,'P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)',2.0000,'F','2011-09-21 21:49:23','2011-09-23 00:40:19');
/*!40000 ALTER TABLE `oc2v_tax_rate` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_tax_rate_to_customer_group`
--

DROP TABLE IF EXISTS `oc2v_tax_rate_to_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_tax_rate_to_customer_group` (
...
--
-- Dumping data for table `oc2v_tax_rate_to_customer_group`
--

LOCK TABLES `oc2v_tax_rate_to_customer_group` WRITE;
/*!40000 ALTER TABLE `oc2v_tax_rate_to_customer_group` DISABLE KEYS */;
INSERT INTO `oc2v_tax_rate_to_customer_group` VALUES (86,1),(87,1);
/*!40000 ALTER TABLE `oc2v_tax_rate_to_customer_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_tax_rule`
--

DROP TABLE IF EXISTS `oc2v_tax_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_tax_rule` (
...
--
-- Dumping data for table `oc2v_tax_rule`
--

LOCK TABLES `oc2v_tax_rule` WRITE;
/*!40000 ALTER TABLE `oc2v_tax_rule` DISABLE KEYS */;
INSERT INTO `oc2v_tax_rule` VALUES (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);
/*!40000 ALTER TABLE `oc2v_tax_rule` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_upload`
--

DROP TABLE IF EXISTS `oc2v_upload`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_upload` (
...
--
-- Dumping data for table `oc2v_upload`
--

LOCK TABLES `oc2v_upload` WRITE;
/*!40000 ALTER TABLE `oc2v_upload` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_upload` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_url_alias`
--

DROP TABLE IF EXISTS `oc2v_url_alias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_url_alias` (
...
--
-- Dumping data for table `oc2v_user`
--

LOCK TABLES `oc2v_user` WRITE;
/*!40000 ALTER TABLE `oc2v_user` DISABLE KEYS */;
INSERT INTO `oc2v_user` VALUES (1,1,'mutwiri','7dbf0896257793900c1e97e0971a0882214423b8','sDRoJj94e','Patrick','Mutwiri','patwiri@gmail.com','','','127.0.0.1',1,'2016-06-21 08:41:34'),(2,1,'onkoba','d971f6f7f897c2bb4bea8e0b533236167e174969','9bvQP11lZ','sam','onkoba','onkoba@tux.co.ke','','','',1,'2016-07-28 10:35:06'),(3,1,'wambisi','2c3806ea8da6fec1e5b7b3327704a42d88e2ddc5','sPOSwMIRQ','Haggai','Wambisi','wambisi@tux.co.ke','','','',1,'2016-07-28 10:35:51');
/*!40000 ALTER TABLE `oc2v_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_user_group`
--

DROP TABLE IF EXISTS `oc2v_user_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_user_group` (
...
--
-- Dumping data for table `oc2v_voucher`
--

LOCK TABLES `oc2v_voucher` WRITE;
/*!40000 ALTER TABLE `oc2v_voucher` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_voucher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_voucher_history`
--

DROP TABLE IF EXISTS `oc2v_voucher_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_voucher_history` (
...
--
-- Dumping data for table `oc2v_voucher_history`
--

LOCK TABLES `oc2v_voucher_history` WRITE;
/*!40000 ALTER TABLE `oc2v_voucher_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `oc2v_voucher_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_voucher_theme`
--

DROP TABLE IF EXISTS `oc2v_voucher_theme`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_voucher_theme` (
...
--
-- Dumping data for table `oc2v_voucher_theme`
--

LOCK TABLES `oc2v_voucher_theme` WRITE;
/*!40000 ALTER TABLE `oc2v_voucher_theme` DISABLE KEYS */;
INSERT INTO `oc2v_voucher_theme` VALUES (8,'catalog/demo/canon_eos_5d_2.jpg'),(7,'catalog/demo/gift-voucher-birthday.jpg'),(6,'catalog/demo/apple_logo.jpg');
/*!40000 ALTER TABLE `oc2v_voucher_theme` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_voucher_theme_description`
--

DROP TABLE IF EXISTS `oc2v_voucher_theme_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Dumping data for table `oc2v_voucher_theme_description`
--

LOCK TABLES `oc2v_voucher_theme_description` WRITE;
/*!40000 ALTER TABLE `oc2v_voucher_theme_description` DISABLE KEYS */;
INSERT INTO `oc2v_voucher_theme_description` VALUES (6,1,'Christmas'),(7,1,'Birthday'),(8,1,'General');
/*!40000 ALTER TABLE `oc2v_voucher_theme_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_weight_class`
--

DROP TABLE IF EXISTS `oc2v_weight_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_weight_class` (
...
--
-- Dumping data for table `oc2v_weight_class`
--

LOCK TABLES `oc2v_weight_class` WRITE;
/*!40000 ALTER TABLE `oc2v_weight_class` DISABLE KEYS */;
INSERT INTO `oc2v_weight_class` VALUES (1,1.00000000),(2,1000.00000000),(5,2.20460000),(6,35.27400000);
/*!40000 ALTER TABLE `oc2v_weight_class` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_weight_class_description`
--

DROP TABLE IF EXISTS `oc2v_weight_class_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_weight_class_description` (
...
--
-- Dumping data for table `oc2v_weight_class_description`
--

LOCK TABLES `oc2v_weight_class_description` WRITE;
/*!40000 ALTER TABLE `oc2v_weight_class_description` DISABLE KEYS */;
INSERT INTO `oc2v_weight_class_description` VALUES (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz');
/*!40000 ALTER TABLE `oc2v_weight_class_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oc2v_zone`
--

DROP TABLE IF EXISTS `oc2v_zone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oc2v_zone` (
...
-- Dump completed on 2016-07-28 10:38:44
