...
<div id="content"><div class="container-fluid">
	<div class="page-header">
	    <h1>TG KingStore Pro MegaMenu</h1>
	    <ul class="breadcrumb">
	...
	<?php } ?>
	<div class="set-size" id="tg_kspro_megamenu">
...
$(document).ready(function() {
	...
	function menu_updatesort(jsonstring) {
		...
		if (mittXHRobjekt) {
			...
			ajaxRequest.open("GET", "index.php?route=module/tg_kspro_megamenu&token=<?php echo $_GET['token']; ?>&jsonstring=" + jsonstring, true);
